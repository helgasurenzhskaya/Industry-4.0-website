        ...
        $articles->insert([
            ...
            <div class="wrapper">
              <div class="content-wrapper">
                <span class="first-character">Н</span><p>а сучасному етапі розвитку промисловості інформаційні технології стають невід’ємною частиною системи автоматизації виробництва. Промислова автоматизація має свою історію застосування комерційних технологій, коли вони стають широко доступними. Наприклад, планшетні комп’ютери з Wi-Fi тепер широко використовують для поліпшення роботи та ефективності обслуговування. </p>
            <p> Подальше поєднання інформаційних та виробничих технологій створює потенціал, здатний дійсно змінити ланцюг від виробництва через постачальників до клієнтів на кожному етапі їх взаємодії. </p>
            <p> Упродовж останніх кількох років спостерігається підвищена активність в сфері створення кіберфізичних систем, поєднань фізичних та кібернетичних компонентів, які забезпечують організацію вимірювально-обчислювальних процесів, захищене зберігання службової інформації. </p>
            
            <div class="image-left">
                  <img src=" #" /> 
            Спираючись на концепцію кіберфізичних систем, провідні наукові установи та групи в усьому світі спрямовують свої зусилля на пошук нових напрямів розвитку інформаційно-обчислювальних технологій об’єднанням та інтегруванням різних за призначенням підсистем у єдину децентралізовану та гнучку систему. </p>
            </div>
            
            
            
               <p> Інтеграція фізичних процесів та обчислень не є чимось новим. Для опису таких систем давно використовують термін “вбудовані системи”. Серед успішних їх застосувань – системи зв’язку, домашня автоматика, озброєння, повітряний та наземний транспорт тощо. До перших розробок цього напряму належать створені нами вбудовані процесори та комп’ютерні системи, впроваджені в технічних комплексах як цивільного, так і військового призначення. Зокрема, це розробка та впровадження низки процесорів спектрального аналізу радіолокаційних сигналів, розробка та впровадження ряду програмованих процесорів цифрового опрацювання сигналів, створення широкого спектра спеціалізованих процесорів багатовимірного спектрального аналізу сигналів та зображень, шифрування та кодування інформації, тощо.</p>
            
            
            <p> Ще одним ключовим елементом, що вплинув на формування концепції кіберфізичних систем, є сучасні засоби телекомунікацій. Сьогодні ці засоби забезпечують взаємодію компонентів системи практично довільного розміщення з використанням як дротового, так і бездротового зв’язку. 
            
            </div></div> ',
            'text_en' => '<div class="wrapper">
            <div class="content-wrapper">
              <span class="first-character">A</span><p>t the present stage of the development of industry, information technology becomes an integral part of the automation system of production. Industrial automation has its own history of commercial technology when it becomes widely available. For example, tablet PCs with Wi-Fi are now widely used to improve performance and serviceability.</p>
              ...
              <p>Over the past few years, there has been increased activity in the field of the creation of cyber-physics systems, combinations of physical and cybernetic components that provide the organization of measurement and computing processes, and protect the storage of official information.</p>
          ...
          Cyber-physical systems are physical and engineered systems whose operations are monitored, coordinated, controlled and integrated by a computing and communication core. Just as the internet transformed how humans interact with one another, cyber-physical systems will transform how we interact with the physical world around us.    </div>
              ...
              <p>Building on the concept of cyber-physics systems, leading research institutions and groups around the world are focusing their efforts on finding new areas for the development of information and computing technologies by integrating and integrating different subsystems into a single, decentralized and flexible system. </p>
          
          <p>Integration of physical processes and computing is not something new. The term "embedded systems" has long been used to describe such systems. Among their successful applications are communication systems, home automation, armaments, air and land transport, and so on. The first developments in this area include built-in built-in processors and computer systems implemented in technical systems for both civilian and military purposes. In particular, it is the development and implementation of a number of spectrum analysis processors for radar signals, the development and implementation of a number of programmable processors for digital signal processing, the creation of a wide range of specialized processors for multimodal spectral analysis of signals and images, encryption and encoding of information, etc.</p>
          
                  
              <p>In the manufacturing environment, CPSs can improve processes by sharing real-time information among the industrial machines, manufacturing supply chain, suppliers, business systems, and customers. Also, CPSs can improve these processes by self-monitoring and controlling the entire production processes and then adapting production to satisfy customers' preferences. CPSs provide a higher degree of visibility and control on supply chains, improving the traceability and security of goods.</p>
          
          <p>In the healthcare environment, CPSs are used for real-time and remote monitoring of the physical conditions of patients to limit patient hospitalization (for example, for patients who suffer from Alzheimer's disease) or to improve treatments for disabled and elderly patients. Moreover, CPSs are used in research in the neuroscience field to better understand human functions with the support of brain-machine interfaces and therapeutic robotics.</p>
          ...
          <p>In the renewable energy environment, smart grids are CPSs where sensors and other devices monitor the grid to control it and provide better reliability and improve the energy efficiency.</p>
          
          <p>In smart building environments, smart devices and CPSs interact to reduce energy consumption, to increase safety and security, and to improve inhabitants comfort. For example, with CPSs you can enable energy monitoring and control systems usage, which help you achieve zero-energy buildings, or you can determine the extent of damage that buildings suffer after unexpected events and help prevent structural failures.</p>
          
          <p>In the transportation environment, individual vehicles and the infrastructure can communicate with each other, sharing real-time information about traffic, location, or issues, in order to prevent accidents or congestion, improve safety, and ultimately save money and time.</p>
          
          <p>In the agriculture environment, CPSs can be used to create more modern and precise agriculture. CPSs can collect fundamental information about the climate, the ground, and other data, in order to realize more accurate systems of agricultural management. CPSs can constantly monitor different resources, such as watering, humidity, plant health and others, through sensors and, thus, keep the ideal environmental values.</p>
          
          <p>In computer networks, CPSs can boost cyber environments to better understand systems and users' behaviors, which can help improve performances and resource management. For example, applications can be optimized to work in relation to the contexts and to the users' actions, or to monitor available resources. Moreover, popular social networks and e-commerce websites store users' navigation information and users' web content, analyzes that information, and then tries to predict interests and make recommendation for friends, posts, links, pages, events, or products.</p>
           ...
           ',
            ...
            [
                ...
                // 'image' => '',
                'text_uk' => ' <div class="content-wrapper">
                <span class="first-character">В</span> <p>еликі дані стали модним словом у бізнесі, а їхні можливі переваги та підводні камені отримують все більшу увагу з боку засобів масової інформації в усьому світі. Переважна кількість даних, що збираються, зберігаються і передаються через нові технології, перебудовують пріоритети для багатьох підприємств, і розробка нових аналітичних інструментів підлаштовується під інші глибокі зрушення у тому, як компанії працюють заради трансформації бізнесу.</p>
            <p>Великі дані - це сукупність технологій, які покликані  обробляти великі в порівнянні з «стандартними» сценаріями обсяги даних, вміти працювати з даними, що швидко поступають в дуже великих обсягах, повинні вміти працювати зі структурованими і погано структурованими даними паралельно в різних аспектах.</p>
            <div class="image-left">
                  <img src="#" /> 
            Найцікавіше, що Big Data вже багато років формує наш щоденний спосіб життя і впливає на наші вчинки та рішення.  </div>
            ...
            <p>Тільки в Google відбувається близько 40 000 пошукових запитів щомиті, що дає близько 1,2 трильйона пошукових запитів для великих даних щорічно. І з кожним днем кількість даних збільшується все швидше. Якщо сьогодні ми генеруємо 4,4 зетабайта даних, то до 2020 ми будемо створювати вже 44. До 2020 року майже третина всіх даних буде проходити через хмарні сервіси, а значить буде піддана аналізу.</p>
            
                <div class="image-right">
                  <img src="https://images.unsplash.com/photo-1461685265823-f8d5d0b08b9b?ixlib=rb-0.3.5&s=f70737b52dd5cb3615f3e115d90f50d4&auto=format&fit=crop&w=750&q=80" /> 
            Цікаво, що для аналізу великих даних не завжди використовуються комп'ютери корпорацій. 
            
            
                </div>
            
            <p>Часто користувачі самі надають свої комп'ютери для вирішення різних наукових завдань. В цей же час 73% організацій проінвестували або збираються проінвестувати в розвиток великих даних. Великі компанії типу Google, Facebook і навіть держави обробляють і використовують цю інформацію для поліпшення нашого способу життя. Ну, або для показу більш релевантної реклами.</p>
            <p>На основі цих даних ми можемо не тільки отримувати таргетовану рекламу, орієнтовану тільки на нас, але і значно поліпшити наше життя.  Сьогодні обробці піддається лише 0,5% усіх доступних даних. Тому найцікавіше все ще в майбутньому.</p>
                ...
                <div class="content-wrapper">
                  ...
                  <p> Large data is a collection of technologies designed to process large volumes of data in comparison with "standard" scenarios, to be able to work with data that is rapidly arriving at very large volumes, should be able to work with structured and poorly structured data in parallel in various aspects . </p>
                  
              <div class="image-left">
                    <img src="#" /> 
              Most interestingly, Big Data has been shaping our daily lives for many years and influencing our actions and solutions.</div>
              
              
              
                  <p>Larger data is a way of processing huge and varied arrays of information coming in every second. It's important to quickly process and structure these data in order to get something useful from the future. How do we deal with Big Data every day? Man is the main generator and consumer of large data. Every day we create so much new information as we've been creating for decades. We generate information not only through photographs and social posts. This is our every search query, a step calculated by the fitness tracker, a video viewed on YouTube. Almost every one of our actions is written to somebody and becomes part of Big Data. </p>
              
                    <p> Google only has about 40,000 searches every second, giving about 1.2 trillion searches for large data annually. And every day, the amount of data increases faster. If today we generate 4.4 zebaytes of data, then by 2020 we will create 44. By 2020, almost a third of all data will pass through cloud services, and hence will be analyzed. </ p>
              ...
              <p>Often, users themselves provide their computers for solving various scientific problems. At the same time, 73% of organizations have been or are about to invest in the development of large data. Large companies like Google, Facebook, and even governments handle and use this information to improve our lifestyle. Well, either to show more relevant ads. </ p>
              <p> Based on this data, we can not only receive targeting ads that are targeted only to us but also significantly improve our lives. Today only 0.5% of all available data is processed. Therefore, the most interesting is still in the future. </ p>
            ...
            [
                ...
                // 'image' => '',
                'text_uk' => '<div class="wrapper">
                <div class="content-wrapper">
                  <span class="first-character">Ш</span><p>тучний інтелект (ШІ) – один із перспективних напрямів подальшого розвитку інформаційних систем та технологій. Для вирішення питань, пов’язаних із застосуванням систем штучного інтелекту, зосереджені великі зусилля фахівців у галузі кібернетики, лінгвістики, психології, філософії, математики та інженерів. Саме тут вирішується багатогранні питання, пов'язані з шляхами розвитку наукової думки, з впливом досягнень в області обчислювальної техніки та робототехніки на життя майбутніх поколінь. </p>
              
              <div class="image-left">
                    <img src="#" /> 
              Незважаючи на вже тривалий розвиток систем ШІ, на даний момент немає навіть точного визначення штучного інтелекту.     </div>
              
              <p>Вчені не мають одностайної позиції у питанні визначення даного об’єкту досліджень: ведучи мову про штучний інтелект, його здебільшого тлумачать як формалізацію завдань і функцій, подібних до тих, які виконує людина.</p>
              <p>Слід відзначити два підходи до штучного інтелекту, що склалися в сучасній філософії: сильна версія штучного інтелекту і слабка версія штучного інтелекту. Перша передбачає, що комп'ютери можуть набути здатності до рефлексивної розумової діяльності й до усвідомлення себе, навіть якщо процес їх мислення буде відрізнятися від людського. Слабка версія штучного інтелекту відкидає будь-яку можливість мислення для комп'ютерів.</p>
              ...
              <p>Період 1960-70-х років позначився особливо інтенсивним обговоренням проблем, пов'язаних зі створенням, функціонуванням і сутністю обчислювальних машин, що породило ряд метафор на кшталт: “електронний мозок”, “інтелектуальна машина”, “мислячий пристрій” тощо. Після того, як у Вашингтоні (1969) відбулась перша міжнародна конференція по штучному інтелекту, метафору «штучний інтелект» почали масово використовувати в науково-технічному середовищі.</p>
              <p>Відносини між людиною і машиною в умовах розвитку систем штучного інтелекту і впровадження їх у людську повсякденність набувають дедалі більш складного і важко передбачуваного характеру. Використання штучного інтелекту має багато як позитивних так і негативних аспектів. Як влучно зазначає Б.Уітбі, що як і будь-яка інша технологія, штучний інтелект можна використовувати з позитивними соціальними наслідками, а можна і створити умови для соціальної катастрофи.
              </p>
                ...
                'text_en' => '<div class="wrapper">
                <div class="content-wrapper">
                  <span class="first-character">A</span><p>rtificial Intelligence (AI) is one of the promising directions for the further development of information systems and technologies. To solve issues related to the application of artificial intelligence, concentrated efforts of specialists in the field of cybernetics, linguistics, psychology, philosophy, mathematics and engineers. It is here that solves many-sided issues related to the ways of developing scientific thought, with the influence of advances in the field of computing and robotics on the lives of future generations. </ p>
              <p> Despite the prolonged development of AI systems, at this time there is no even precise definition of artificial intelligence. Scientists do not have a unanimous position regarding the definition of this object of research: while speaking about artificial intelligence, it is mostly interpreted as formalizing tasks and functions similar to those performed by a person. </ p>
              
              
              <div class="image-left">
                    <img src=" #" /> 
              It should be noted two approaches to artificial intelligence in the modern philosophy: a strong version of artificial intelligence and a weak version of artificial intelligence.    </div>
              
              
              
                  <p>The first suggests that computers can acquire the ability to reflexive mental activity and awareness of themselves, even if the process of their thinking will be different from human. A weak version of artificial intelligence discourages any thinking ability for computers. </ P>
              <p> The period from the 1960s and 1970s was marked by a particularly intense discussion of problems associated with the creation, operation and essence of computers, which gave rise to a number of metaphors such as: "electronic brain", "intellectual machine", "thinking device," etc. . After the first international conference on artificial intelligence in Washington (1969), the "artificial intelligence" metaphor began to be used massively in the scientific and technical environment.</p>
              <p>The relationship between man and machine in the development of systems of artificial intelligence and their introduction into human everyday life becomes increasingly complex and difficult to predict. 
